...
class Decision_extController {
    ...
    def save() {
        ...
        flash.message = message(code: 'default.created.message', args: [message(code: 'decision_ext.label', default: 'Decision_ext'), decision_extInstance.id])
    ...
    def show(Long id) {
        ...
        if (!decision_extInstance) {
            flash.message = message(code: 'default.not.found.message', args: [message(code: 'decision_ext.label', default: 'Decision_ext'), id])
    ...
    def update(Long id, Long version) {
        ...
        flash.message = message(code: 'default.updated.message', args: [message(code: 'decision_ext.label', default: 'Decision_ext'), decision_extInstance.id])
        redirect(action: "show", id: decision_extInstance.id)
    }
    ...
    def delete(Long id) {
        ...
        try {
            ...
            flash.message = message(code: 'default.deleted.message', args: [message(code: 'decision_ext.label', default: 'Decision_ext'), id])
            redirect(action: "list")
        }
        catch (DataIntegrityViolationException e) {
            flash.message = message(code: 'default.not.deleted.message', args: [message(code: 'decision_ext.label', default: 'Decision_ext'), id])
