...
class ExtraController {
    ...
    def show(Long id) {
        ...
        if (!extraInstance) {
            flash.message = message(code: 'default.not.found.message', args: [message(code: 'extra.label', default: 'Extra'), id])
    ...
    def delete(Long id) {
        ...
        try {
            ...
            flash.message = message(code: 'default.not.deleted.message', args: [message(code: 'extra.label', default: 'Extra'), id])
