...
class SignerController {
    ...
    def show(Long id) {
        ...
        if (!signerInstance) {
            flash.message = message(code: 'default.not.found.message', args: [message(code: 'signer.label', default: 'Signer'), id])
    ...
    def delete(Long id) {
        ...
        try {
            ...
            flash.message = message(code: 'default.deleted.message', args: [message(code: 'signer.label', default: 'Signer'), id])
            redirect(action: "list")
        }
        catch (DataIntegrityViolationException e) {
            flash.message = message(code: 'default.not.deleted.message', args: [message(code: 'signer.label', default: 'Signer'), id])
