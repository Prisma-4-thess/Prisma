...
<body>
	<a href="#list-type" class="skip" tabindex="-1"><g:message
			...
			<thead>
				<tr>
					...
					<g:sortableColumn property="label"
						title="${message(code: 'type.label.label', default: 'Label')}" />
			...
			<tbody>
				<g:each in="${typeInstanceList}" status="i" var="typeInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${typeInstance.id}">
								${fieldValue(bean: typeInstance, field: "label")}
							</g:link></td>
