    ...
    <ol class="property-list decision">
        ...
        <g:if test="${decisionInstance?.decisionToCorrect}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="decisionToCorrect-label"><g:link controller="decision" action="show"
                                                                                               id="${decisionInstance?.decisionToCorrect?.id}">${decisionInstance?.decisionToCorrect}</g:link></span>
        ...
        <g:if test="${decisionInstance?.geo}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="geo-label"><g:link controller="geo" action="show" id="${decisionInstance?.geo?.id}">${decisionInstance?.geo}</g:link></span>
