			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="label" title="${message(code: 'geo.label.label', default: 'Label')}" />
				...
				<g:each in="${geoInstanceList}" status="i" var="geoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${geoInstance.id}">${fieldValue(bean: geoInstance, field: "label")}</g:link></td>
