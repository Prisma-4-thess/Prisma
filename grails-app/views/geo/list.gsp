			...
			<thead>
				<tr>
					...
					<g:sortableColumn property="address"
						title="${message(code: 'geo.address.label', default: 'Address')}" />

					<g:sortableColumn property="tk"
						title="${message(code: 'geo.tk.label', default: 'Tk')}" />

					<g:sortableColumn property="newCat"
						title="${message(code: 'geo.newCat.label', default: 'New Cat')}" />

					<g:sortableColumn property="namegrk"
						title="${message(code: 'geo.namegrk.label', default: 'Namegrk')}" />
			...
			<tbody>
				<g:each in="${geoInstanceList}" status="i" var="geoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>
							${fieldValue(bean: geoInstance, field: "address")}
						</td>

						<td>
							${fieldValue(bean: geoInstance, field: "tk")}
						</td>

						<td>
							${fieldValue(bean: geoInstance, field: "newCat")}
						</td>

						<td>
							${fieldValue(bean: geoInstance, field: "namegrk")}
						</td>
