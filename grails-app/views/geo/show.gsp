	...
	<body>
		...
		<div id="show-geo" class="content scaffold-show" role="main">
			...
			<ol class="property-list geo">
				...
				<li class="fieldcontain">
					<span id="label-label" class="property-label"><g:message code="geo.label.label" default="Label" /></span>
					
						<span class="property-value" aria-labelledby="label-label"><g:fieldValue bean="${geoInstance}" field="label"/></span>
