			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="latinName" title="${message(code: 'organization.latinName.label', default: 'Latin Name')}" />
				...
				<g:each in="${organizationInstanceList}" status="i" var="organizationInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: organizationInstance, field: "latinName")}</td>
